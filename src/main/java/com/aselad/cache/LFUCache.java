...
public class LFUCache implements KVCache {
    ...
    /**
     * get method used to get a cache.KVItem from a cache
     * @param key : key of the required item
     * @return : cache.KVItem object of requested key
     */
    @Override
    public KVItem get(String key) {
        ...
        try {
            ...
            if (this.cache.containsKey(key)){
                ...
                logger.info("cache.KVItem is found the cache for <key> : "+key);
     ...
     * @param item : cache.KVItem that need to put to the cache
     */
    @Override
    public void put(KVItem item) {
        try {
            ...
            logger.info("new cache.KVItem added to the cache");
        }finally {
     ...
     * @param item : cache.KVItem object that need to delete from the cache
     */
    @Override
    public void delete(KVItem item) {
        try {
            ...
            if (this.cache.containsKey(key)){
                ...
                logger.info("cache.KVItem is deleted from the cache");
            }
